...
import {MdOutlineAddPhotoAlternate, MdOutlineShare, MdOutlineIosShare} from 'react-icons/md'
import {
    HiOutlineHome,
    HiHome,
    HiOutlinePhotograph,
...
function Navbar() {
    ...
    const [hoverMembers, setHoverMembers] = useState(0)
    const [hoverMypage, setHoverMypage] = useState(0)
    ...
    return (
        <div className={styles.container}>
            <div className={styles.logo}>
                <img src="https://cdn-icons-png.flaticon.com/512/148/148813.png" alt="" />
            ...
            <div className={styles.nav}>
                <ul>
                    ...
                    <li>
                        <button
                            ...
                            onMouseOver={() => setHoverPhoto(1)}
                            onMouseOut={() => setHoverPhoto(0)}
                        >
                            {hoverPhoto ? (
                                <div>
                                    <HiPhotograph />
                    ...
                    <li>
                        <button
                            className={styles.btn}
                            onClick={() => navigate('/user/album')}
                            onMouseOver={() => setHoverMypage(1)}
                            onMouseOut={() => setHoverMypage(0)}
                        >
                            {hoverMypage ? (
                                <div>
                                    <HiUser />
                ...
                <div className={styles.contents}>
                    <div className={styles.ContentsTabs}>
                        <HiOutlineChevronRight />
                        파일
                        <ul>
                            <li>
